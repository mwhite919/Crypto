...
<div><AreaChart width={430} height={250} data={graphData}
  ...
  <Tooltip />
  <Area type="monotone" dataKey="price" stroke="#82ca9d" fillOpacity={1} fill="url(#color1)" />
  <Area type="monotone" dataKey="price" stroke="#82ca9d" fillOpacity={1} fill="url(#color2)" />
  <Area type="monotone" dataKey="price" stroke="#82ca9d" fillOpacity={1} fill="url(#3)" />
</AreaChart>
  </div>
  );
};
